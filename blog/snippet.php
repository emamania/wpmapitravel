...
// UPDATE wp_users SET user_pass = MD5( 'nuevaclave' ) WHERE user_login = 'miusuario'; ==> Restablecer la contraseña de un usuario
// UPDATE wp_posts SET post_type = 'page' WHERE post_type = 'post'; ==> Convertir entradas en páginas: o inversa
// UPDATE wp_post SET post_content = replace(post_content, '[el-shortcode-a-borrar]', '' ); ==> Eliminar shortodes
...
=               URL WHATSAAP               =
=============================================*/
echo '<a href="https://wa.me/3412345678?text=Mensaje%20por%20defecto">Texto a mostrar con el enlace<\a>';

/*=============================================
=   BLOQUEO EL CAMBIO DE URLS wp-config.php   =
=============================================*/
